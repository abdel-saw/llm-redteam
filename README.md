...
[![PFE](https://img.shields.io/badge/PFE-Ing%C3%A9nierie%20Informatique%20%C2%B7%20FST%20Settat-0a1929.svg)](#auteur--cr%C3%A9dits)
...
Réalisé dans le cadre d'un **Projet de Fin d'Études** de la filière
*Ingénierie Informatique* à la **FST Settat — Université Hassan 1er**
(Maroc), promotion 2025/2026.

- **Auteur** : Abdel Sawadogo — [abdelsawadogo51@gmail.com](mailto:abdelsawadogo51@gmail.com)
- **Encadrant académique** : Pr Dabounou
...
(Anthropic), used as a pair-programming and refactoring tool
throughout the implementation phase. All architectural decisions,
security audits, and final reviews were carried out by the author.
The pre-commit hook and pytest security scanner included in this
repository were specifically designed to catch any accidental
secrets — including those that could be generated by AI assistants —
before they enter the codebase.

Other key tools and libraries:

- **FastAPI**, **HTMX**, **Tailwind CSS** — application stack
- **Groq Cloud** — LLM inference provider (Llama 3.3 70B for
  attacker/judge, GPT-OSS-Safeguard 20B for safety classification)
- **OpenRouter** — fallback LLM provider
- **Hugging Face Spaces** — public deployment platform

---

## Licence

[MIT](LICENSE) © 2026 Abdel Sawadogo.
